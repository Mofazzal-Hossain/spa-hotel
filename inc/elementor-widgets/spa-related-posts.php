<?php
class Spa_Related_Posts extends \Elementor\Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Spa Related Posts', 'spa-hotel-toolkit');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'related_posts',
            [
                'label' => __('Related Posts', 'spa-hotel-toolkit'),
...
?>
        <div class="sht-related-posts-wrapper sht-blog-posts">
            <div class="swiper sht-related-posts-slider">
                <div class="swiper-wrapper sht-blog-grid-section ">
                    <?php if ($query->have_posts()) : ?>
                        <?php while ($query->have_posts()) : $query->the_post(); ?>
                            <div class="sht-col-item sht-post-single-item swiper-slide">
        ...
        <script>
            jQuery(document).ready(function() {
                new Swiper(".sht-related-posts-slider", {
                    slidesPerView: 3,
                    spaceBetween: 32,
                    speed: 2500,
                    autoplay: {
                    ...
                    loop: true,
                    pagination: {
                        el: ".sht-related-posts-slider .sht-pagination",
                        clickable: true,
                    },
                    navigation: {
                        nextEl: ".sht-related-posts-slider .sht-next",
                        prevEl: ".sht-related-posts-slider .sht-prev",
                    },
                    breakpoints: {
                        1024: {
                            slidesPerView: 3,
