...
<div class="tf-single-description spa-single-section">
    <h4 class="tf-section-title"><?php echo esc_html__('About', 'spa-hotel-toolkit'); ?></h4>
    ...
    <div class="tf-hotel-place-review">
        <ul>
            <li>
                <div class="rating">
                    <?php echo esc_html__('8.2', 'spa-hotel-toolkit'); ?>
                ...
                <div class="review-info">
                    <h6><?php echo esc_html__('Very Good', 'spa-hotel-toolkit'); ?></h6>
                    <p><?php echo esc_html__('250 reviews on Booking.com', 'spa-hotel-toolkit'); ?></p>
                </div>
            </li>
            <li>
                ...
                <div class="review-info">
                    <h6>
                        ...
                        <span><?php echo esc_html__('4.5', 'spa-hotel-toolkit'); ?></span>
                    </h6>
                    <p><?php echo esc_html__('250 reviews on Google', 'spa-hotel-toolkit'); ?></p>
                </div>
            </li>
            <li>
                ...
                <div class="review-info">
                    <h6>
                        ...
                        <span><?php echo esc_html__('5.0', 'spa-hotel-toolkit'); ?></span>
                    </h6>
                    <p><?php echo esc_html__('250 reviews on Google', 'spa-hotel-toolkit'); ?></p>
                </div>
            </li>
