...
// booking.com rating
$rating_booking_url = ! empty($hotel_meta['rating-booking-url']) ? $hotel_meta['rating-booking-url'] : '#';
...
// google rating
$rating_google_url = ! empty($hotel_meta['rating-google-url']) ? $hotel_meta['rating-google-url'] : '#';
...
// tripadvisor rating
$rating_tripadvisor_url = ! empty($hotel_meta['rating-tripadvisor-url']) ? $hotel_meta['rating-tripadvisor-url'] : '#';
...
<div class="tf-single-description spa-single-section">
    ...
    <div class="tf-hotel-place-review">
        <ul>
            <li>
                <a href="<?php echo esc_url($rating_booking_url); ?>" target="_blank">
                    <div class="rating">
            ...
            <li>
                <a href="<?php echo esc_url($rating_google_url); ?>" target="_blank">
            ...
            <li>
                <a href="<?php echo esc_url($rating_tripadvisor_url); ?>" target="_blank">
