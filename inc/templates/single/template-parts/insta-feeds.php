...
$accessToken = '';
$businessUsername = 'mofazzalpersonal';
$instagramBusinessAccountId = '17841477682743333';

// cURL request
$ch = curl_init();
$fields = "business_discovery.username($businessUsername){username,profile_picture_url,followers_count,media_count,media{caption,like_count,comments_count,permalink,media_url,media_type,timestamp}}";
$url = "https://graph.facebook.com/v24.0/$instagramBusinessAccountId?fields=" . urlencode($fields) . "&access_token=$accessToken";
...
$author = $data['business_discovery'] ?? null;
$mediaPosts = $author['media']['data'] ?? [];
?>
<div class="tf-insta-feeds spa-single-section">
    ...
    <div class="tf-insta-post-wrap">
        <?php if (!empty($mediaPosts)): ?>
            <?php foreach (array_slice($mediaPosts, 0, 7) as $post): ?>
                <div class="tf-insta-post">
                    <div class="tf-insta-post-top">
                        ...
                        <!-- Post image/video -->
                        <?php if ($post['media_type'] == 'IMAGE' || $post['media_type'] == 'CAROUSEL'): ?>
                            <img class="tf-insta-feed-image" src="<?php echo esc_url($post['media_url']); ?>" alt="Instagram Image">
                        <?php elseif ($post['media_type'] == 'VIDEO'): ?>
                            <video class="tf-insta-feed-image" src="<?php echo esc_url($post['media_url']); ?>" controls></video>
                        <?php endif; ?>

                        <div class="insta-user-info">
                            <?php if(!empty($author['profile_picture_url'])): ?>
                                <img src="<?php echo esc_url($author['profile_picture_url']); ?>" alt="Avatar">    
                            <?php
                            else:
                                echo '<img src="' . esc_url(SHT_HOTEL_TOOLKIT_ASSETS . 'images/user-fallback-image.jpeg') . '" alt="Avatar">';
                            endif; ?>
                            <a href="https://instagram.com/<?php echo esc_attr($author['username']); ?>" target="_blank">
                                <?php echo esc_html('@' . $author['username']); ?>
                            </a>
                        </div>
                    </div>

                    <div class="tf-insta-post-bottom">
                        <a href="<?php echo esc_url($post['permalink']); ?>" class="tf-post-title" target="_blank">
                            <?php echo esc_html($post['caption']); ?>
                        </a>
                        <div class="tf-post-meta">
                            <ul>
                                <li>
                                    ...
                                    <span><?php echo esc_html($post['like_count']); ?></span>
                                </li>
                                <li>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <span><?php echo esc_html($post['comments_count']); ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <?php endforeach;
            ...
            echo '<p>' . esc_html__('No posts found.', 'spa-hotel-toolkit') . '</p>';
        endif;
        ?>
